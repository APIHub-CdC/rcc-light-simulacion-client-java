...
public class RCCLightFicodcorePldApi {
	...
	public Domicilios getDomicilios(String folioConsulta, String xApiKey) throws ApiException {
		ApiResponse<Domicilios> resp = getDomiciliosWithHttpInfo(folioConsulta, xApiKey);
		return resp.getData();
	}

	public ApiResponse<Domicilios> getDomiciliosWithHttpInfo(String folioConsulta, String xApiKey) throws ApiException {
	...
	private okhttp3.Call getReporteValidateBeforeCall(String xApiKey, PersonaPeticion body, Boolean xFullReport,
		...
		okhttp3.Call call = getReporteCall(xApiKey, body, xFullReport, progressListener, progressRequestListener);
		return call;
	}
	...
	public okhttp3.Call getScoresCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody = null;
	...
	private okhttp3.Call getScoresValidateBeforeCall(String folioConsulta, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (folioConsulta == null) {
